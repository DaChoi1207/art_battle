              ...
              {!user ? (
                ...
                <div className="flex flex-col items-center w-full">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-300 to-pink-300 flex items-center justify-center text-2xl font-bold">
                      {user.username ? user.username[0].toUpperCase() : '?'}
                    </span>
                    <div className="flex flex-col">
                      <span className="font-bold text-2xl leading-tight text-gray-800">{user.username}</span>
