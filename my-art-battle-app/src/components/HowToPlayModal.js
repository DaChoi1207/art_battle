  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="title-font text-2xl font-semibold mb-4 text-center text-[#a685e2]">How To Play</h2>
        <ul className="space-y-3 text-[var(--color-text)] text-base title-font">
          <li><b>1. Join or create a lobby.</b></li>
          <li><b>2. When the game starts,</b> draw the prompt as best as you can!</li>
          <li><b>3. Vote for your favorite drawing.</b></li>
          <li><b>4. The player with the most votes wins the round!</b></li>
        </ul>
